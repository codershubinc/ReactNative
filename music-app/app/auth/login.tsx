...
const LoginPage = () => {
    ...
    const logOutUserForTesting = async () => {
        try {
            ...
            >
                <ScrollView contentContainerStyle={{ flexGrow: 1, justifyContent: 'center', alignItems: 'center' }}>
                    ...
                    >
                        ...
                        />
                        <ButtonComp
                            onClick={() => logOutUserForTesting()}
                            title="LogOut"
                            color=''
                            isLoading={false}
                        />
                        <Text className='text-white test'>
                            your battery level { (batteryLevel ) }
                            {/* your battery level { Math.round(batteryLevel * 100) } */}
                        </Text>
                    </View>
                </ScrollView>
            </KeyboardAvoidingView>
